...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_FluoroUpperPanel = wx.Panel( sbFluoroDetectorSizer.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,220 ), wx.TAB_TRAVERSAL )
		sbFluoroDetectorSizer.Add( self.m_FluoroUpperPanel, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_staticline1 = wx.StaticLine( sbFluoroDetectorSizer.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		sbFluoroDetectorSizer.Add( self.m_staticline1, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_FluoroLowerPanel = wx.Panel( sbFluoroDetectorSizer.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,220 ), wx.TAB_TRAVERSAL )
		sbFluoroDetectorSizer.Add( self.m_FluoroLowerPanel, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_FluoroRBGroupPanel = wx.Panel( sbFluoroDetectorSizer.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
